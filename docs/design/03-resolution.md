...
[`stemma-embed`](../../crates/stemma-embed/src/lib.rs). The LM band is
designed in [05-encoders-decoders.md](05-encoders-decoders.md); it is not
built, and nothing in this document depends on it.
